...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('t',
    sa.Column('j', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=True)
    )
    op.create_table('t1',
    sa.Column('j', postgresql.JSON(astext_type=sa.Text()), autoincrement=False, nullable=True)
    )
